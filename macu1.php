      ...
      <section class="mainContent">
        <div class="productRow">
          ...
          <article class="productInfo">
            <div class="productimg"><button><a href="javascript:" onclick="hide1.style.display=hide1.style.display=='none'?'':'none'"><img src="http://www.maculife.com.tw/upload/product/images/202005151516441.JPG" alt="sample" height="125"></a></button></div>
          ...
          <article class="productInfo">
            <div class="productimg"><button><a href="javascript:" onclick="hide2.style.display=hide2.style.display=='none'?'':'none'"><img alt="sample" src="http://www.maculife.com.tw/upload/product/images/202005151508021.JPG" height="125"></a></button></div>
          ...
          <article class="productInfo">
            <div class="productimg"><button><a href="javascript:" onclick="hide3.style.display=hide3.style.display=='none'?'':'none'"><img src="http://www.maculife.com.tw/upload/product/images/202005151523011.JPG" alt="sample" height="125"></a></button></div>
          ...
          <article class="productInfo">
            <div class="productimg"><button><a href="javascript:" onclick="hide4.style.display=hide4.style.display=='none'?'':'none'"><img alt="sample" src="http://www.maculife.com.tw/upload/product/images/202106181039381.JPG" height="125"></a></button></div>
            <span id="hide4" style="display:none">總糖量(克)/總熱量(卡):<br />L:53/288<br />瓶:90/495</span>
            <p class="price">L:$75 瓶:$100</p>
            <p class="productContent">葡萄柚果粒蜜茶</p>
          ...
          <article class="productInfo">
            <div class="productimg"><button><a href="javascript:" onclick="hide5.style.display=hide5.style.display=='none'?'':'none'"><img alt="sample" src="http://www.maculife.com.tw/upload/product/images/202106181040231.JPG" height="125"></a></button></div>
            <span id="hide5" style="display:none">總糖量(克)/總熱量(卡):<br />L:56/320</span>
            <p class="price">L:$75</p>
            <p class="productContent">葡萄柚果粒多多</p>
        ...
        <div class="productRow">
          <article class="productInfo">
            <div class="productimg"><button><a href="javascript:" onclick="hide6.style.display=hide6.style.display=='none'?'':'none'"><img alt="sample" src="http://www.maculife.com.tw/upload/product/images/202005151448521.JPG" height="125"></a></button></div>
