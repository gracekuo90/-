      ...
      <section class="mainContent">
        <div class="productRow">
          ...
          <article class="productInfo">
            <div class="productimg"><button><a href="javascript:" onclick="hide1.style.display=hide1.style.display=='none'?'':'none'"><img src="http://www.maculife.com.tw/upload/product/images/202005151608171.JPG" alt="sample" height="125"></a></button></div>
          ...
          <article class="productInfo">
            <div class="productimg"><button><a href="javascript:" onclick="hide2.style.display=hide2.style.display=='none'?'':'none'"><img alt="sample" src="http://www.maculife.com.tw/upload/product/images/202106181048591.JPG" height="125"></a></button></div>
          ...
          <article class="productInfo">
            <div class="productimg"><button><a href="javascript:" onclick="hide3.style.display=hide3.style.display=='none'?'':'none'"><img src="http://www.maculife.com.tw/upload/product/images/202005151438221.JPG" alt="sample" height="125"></a></button></div>
